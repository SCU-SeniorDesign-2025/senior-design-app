  ...
  return (
    <div style={{display:'flex', justifyContent: 'center'}}>
      ...
      <LoginDiv>
        ...
        <StyledInput placeholder='username' value={name} onChange={(e) => setName(e.target.value)}/>
        <StyledInput placeholder='password' value={pass} onChange={(e) => setPass(e.target.value)}/>
