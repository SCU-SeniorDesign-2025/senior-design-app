    ...
    <div style={{display: 'flex', flexDirection: 'row'}}>
      <Sidebar collapsed={collapse} style={{padding: 0, margin: 0, height: '100vh'}}>
        <Menu>
          ...
          <MenuItem icon={<FaHome style={{height: 200, width: 200}}/>}> Home </MenuItem>
          <MenuItem icon={<FaHistory style={{height: 200, width: 200}}/>}> History </MenuItem>
          <MenuItem icon={<IoIosCreate style={{height: 200, width: 200}}/>}> New Job </MenuItem>
        </Menu>
      </Sidebar>
