...
const Create_Tags = () => {
    ...
    <LongerBacking>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: '50%', alignItems: 'center' }}>
            ...
            <h5 style={{ width: '25%' }}>Room #: </h5> <StyledInput ref={nameRef} style={{ width: '70%' }} placeholder="Rm 109" />
            <h5 style={{ width: '25%' }}>Office Hrs: </h5> <StyledInput ref={nameRef} style={{ width: '70%' }} placeholder="MWF 9-10am, TTH 10-12pm" />
