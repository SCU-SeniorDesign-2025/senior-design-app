...
const Create_Tags = () => {
    ...
    return (
        <div style={{display: 'flex', flexDirection: 'row', background: '#260D0D'}}>
            <Sidebar collapsed={collapse} style={{padding: 0, margin: 0, height: '150vh'}}>
                <Menu>
            ...
            <div style={{display: 'flex', alignItems: 'center', width: '85%', flexDirection: 'column'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: '50%', alignItems: 'center' }}>
                    ...
                    <Preview/>
                    <h4 style={{width: '100%', marginTop: '30px'}}> Time Estimate: {5} hrs</h4>
