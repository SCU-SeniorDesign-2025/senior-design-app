    ...
    <div style={{display: 'flex', flexDirection: 'row'}}>
      <Sidebar collapsed={collapse} style={{padding: 0, margin: 0, height: '100vh'}}>
        <Menu>
          ...
          <MenuItem icon={<FaHistory style={{height: 50, width: 50}}/>} onClick={() => nav('/login')}> History </MenuItem>
          <MenuItem icon={<IoIosCreate style={{height: 50, width: 50}}/>} onClick={() => nav('/home')}> New Job </MenuItem>
        </Menu>
      </Sidebar>
