  ...
  return (
    <div style={{display: 'flex', flexDirection: 'row'}}>
      <Sidebar collapsed={collapse} style={{padding: 0, margin: 0, height: '100vh'}}>
        <Menu>
          <MenuItem icon={<IoIosMenu style={{height: 200, width: 200}}/>} onClick={() => setCollapse(!collapse)}></MenuItem>
          <MenuItem style={{height: 150, width: 150}} icon={<FaHome style={{height: 150, width: 150}}/>}> Home </MenuItem>
          <MenuItem icon={<FaHistory style={{height: 150, width: 150}}/>}> History </MenuItem>
          <MenuItem icon={<IoIosCreate style={{height: 150, width: 150}}/>}> New Job </MenuItem>
        </Menu>
      </Sidebar>
