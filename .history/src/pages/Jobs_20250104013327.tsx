  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column', gap: 40, alignItems: 'center'}}>
      ...
      <div style={{display:'flex', flexDirection: 'row', gap:20, marginBottom: '2rem'}}>
        ...
        <DisplayCard info='Create Name Plates' black_bg={false} status={false} fn={() => console.log('hi_1')}/>
        <DisplayCard info='Create Signage' black_bg={true} status={false} fn={() => console.log('hi_1')}/>
      </div>
    </div>
  )
}
