    ...
    return(
        <div style={{display: 'flex', flexFlow: 'row wrap', justifyContent: 'center', alignItems: 'center', textAlign: 'center', gap: 10}}>
            ...
            <div style={{backgroundColor: 'var(--accent-30)', padding: '.5rem', borderRadius: '.5rem', textAlign: 'center'}}>
                <h6 style={{backgroundColor: dayTime?'var(--accent-100)':'var(--bg-100)', borderRadius: '.5rem', padding: '.3rem .5rem', marginBottom: '.4rem'}} onClick={() => setDayTime(!dayTime)}>AM</h6>
                <h6 style={{backgroundColor: dayTime?'var(--bg-100)':'var(--accent-100)', borderRadius: '.5rem', padding: '.3rem .5rem', }} onClick={() => setDayTime(!dayTime)}>PM</h6>
            </div>
        </div>
    )
}
