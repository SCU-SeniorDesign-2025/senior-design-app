...
const Table = () => {
    ...
    return (
        <div style={{marginTop: '3rem'}} className='table'>
            <style>{tableCss}</style>
            <div className='thead'>
                <h3 style={{width: '25%'}}>Job Name</h3>
                <h3 style={{width: '25%'}}>Status</h3>
                <h3 style={{width: '25%'}}>Time</h3>
                <h3 style={{width: '25%'}}>Account</h3>
            </div>
            {tableData?.map(t => (
                <div className='trow'>
                    <h5 style={{width: '25%'}} >{t.job}</h5>
                    <h5 style={{width: '25%'}} className={t.status==='Working'?'Warning':t.status}>{t.status}</h5>
