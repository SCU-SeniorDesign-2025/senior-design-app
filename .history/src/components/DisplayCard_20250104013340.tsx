...
const DisplayCard: FC<Props> = ({title='', info, black_bg, status=true, fn}) => {
    return (
        <div onClick={fn} className={black_bg?'displayCard accent_avant':'displayCard classic_black'} style={{display: 'flex', flexDirection: 'column'}}>
            <style>{divCss}</style>
            <h5 style={{
