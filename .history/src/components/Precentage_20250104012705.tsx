...
const Precentage: FC<Props> = ({precent}) => {
  return (
    <div style={{display: 'flex', flexDirection: 'row'}}>
        ...
        <div className='precent-indicator'><h5>{precent*100+' hrs'}</h5></div>
        <div style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap'}}>
            <div style={{marginBottom: '.65rem'}} className='precent-container'>
            ...
            <p style={{color: 'var(--accent-100)', width: '45%', marginLeft: '15px'}}>5m ago</p>
            <p style={{color: 'var(--accent-100)', width: '50%', marginLeft: '15px', textAlign: 'center'}}>now</p>
        </div>
    </div>
  )
}
