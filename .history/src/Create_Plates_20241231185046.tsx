...
const Create_Tags = () => {
    ...
    <LongerBacking>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: '50%', alignItems: 'center' }}>
            ...
            <h4 style={{ width: '20%', fontSize: '.5rem' }}>Room #: </h4> <StyledInput ref={nameRef} style={{ width: '70%' }} placeholder="Rm 109" />
            <h4 style={{ width: '20%', fontSize: '.5rem' }}>Office Hrs: </h4> <StyledInput ref={nameRef} style={{ width: '70%' }} placeholder="MWF 9-10am, TTH 10-12pm" />
