...
const Create = () => {
    ...
    return (
        <div style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <div style={{display: 'flex', textAlign: 'center', justifyContent: 'center', width: '85%', flexDirection: 'column'}}>
                <h3 style={{marginTop: 20}}> Start Job </h3>
                
                <div style={{display: 'flex', flexDirection: 'row', gap: 40}}>
                    <LargeButton> <h5> Create New Tags </h5> </LargeButton>
                    <LargeButton> <h5> Create New Plates </h5> </LargeButton>
                </div>
            </div>
        </div>
    )
