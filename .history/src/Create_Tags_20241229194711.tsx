    ...
    return (
        <div style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <div style={{display: 'flex', alignItems: 'center', width: '85%', flexDirection: 'column'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: 400, alignItems: 'center' }}>
                    <h4 style={{display: 'flex', flexGrow: 1}}>Name: </h4><StyledInput style={{display: 'flex', flexGrow: 1}} placeholder='Bucky Bronco'/>
