  ...
  return (
    <div style={{display: 'flex', flexDirection: 'row'}}>
      <Sidebar collapsed={collapse} style={{padding: 0, margin: 0, height: '100vh'}}>
        <Menu>
          <MenuItem icon={<IoIosMenu style={{height: 50, width: 50, marginBottom: 10}}/>} onClick={() => setCollapse(!collapse)}></MenuItem>
          <MenuItem icon={<FaHome style={{height: 50, width: 50}}/>}> Home </MenuItem>
          <MenuItem icon={<FaHistory style={{height: 50, width: 50}}/>}> History </MenuItem>
          <MenuItem icon={<IoIosCreate style={{height: 50, width: 50}}/>}> New Job </MenuItem>
        </Menu>
      </Sidebar>
